...
curl -XDELETE http://localhost:9130/_/proxy/tenants/diku/modules/mod-licenses-1.0.0
curl -XDELETE http://localhost:9130/_/discovery/modules/mod-licenses-1.0.0/localhost-mod-licenses-1.0.0
curl -XDELETE http://localhost:9130/_/proxy/modules/mod-licenses-1.0.0
